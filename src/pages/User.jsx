          ...
          <div className="custom-card-image mb-6 md:mb-0">
            <div className="rounded-lg shadow-xl card image-full">
              ...
              <div className="card-body justify-end">
                <h2 className="card-title text-stone-50 mb-0">{name}</h2>
                <p className="flex text-stone-50 grow-0">{login}</p>
              </div>
            </div>
          </div>
          ...
          <div className="col-span-2">
            <div className=" mb-6">
              <h1 className="text-3xl card-title">
                {name}
                <span className="ml-2 mr-1 text-xs badge-secondary">
                  {type}
                </span>
                {hireable && (
                  <span className="mx-1 text-xs badge">Hireable</span>
                )}
              </h1>
              <p>{bio}</p>
